...
public class RuleDeclaration extends TypeDeclaration<RuleDeclaration> {
    ...
    public RuleDeclaration( TokenRange tokenRange, NodeList<AnnotationExpr> annotations, SimpleName name, RuleBody ruleBody ) {
        super( tokenRange, EnumSet.noneOf(Modifier.class), annotations, name, new NodeList<>() );
